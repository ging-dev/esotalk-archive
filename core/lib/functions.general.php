 ...
 * functions, color functions, URL construction, and array manipluation.
 *
 * @package esoTalk
 */
...
{
    $string = preg_replace(array("/à|á|ạ|ả|ã|â|ầ|ấ|ậ|ẩ|ẫ|ă|ằ|ắ|ặ|ẳ|ẵ/", "/è|é|ẹ|ẻ|ẽ|ê|ề|ế|ệ|ể|ễ/", "/ì|í|ị|ỉ|ĩ/", "/ò|ó|ọ|ỏ|õ|ô|ồ|ố|ộ|ổ|ỗ|ơ|ờ|ớ|ợ|ở|ỡ/", "/ù|ú|ụ|ủ|ũ|ư|ừ|ứ|ự|ử|ữ/", "/ỳ|ý|ỵ|ỷ|ỹ/", "/đ/"), array("a", "e", "i", "o", "u", "y", "d"), mb_strtolower($string));
	$string = preg_replace(array("/[^0-9a-z\s]/", "/\s+/"), array("$1", "-"), $string);
    return $string;
}
